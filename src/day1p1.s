...
.main.process_line:
    ...
    lb      t0, (s2)
    addi    t0, t0, -0x4D # negative if 'L', positive if 'R'
...
.main.dial_continue:
    ...
    add     s5, s5, t0
    rem     s5, s5, t0
    bne     s5, zero, .main.dial_continue_2
.main.dial_is_zero:
    addi    s6, s6, 1
.main.dial_continue_2:
    mv      s2, s3
    j       .main.process_line
...
.ascii_decimal_to_int.loop:
    lb      t1, (a0)
    addi    t1, t1, -0x30 # ascii digit to value
    mul     t2, t2, t3
    add     t2, t2, t1
    addi    a0, a0, 1
